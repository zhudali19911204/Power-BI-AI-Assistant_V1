...
- [ ] 应用窗口能够正常打开，无空白页或错误弹窗。
- [ ] 标题显示“Power BI 智能助手”。
- [ ] 页面显示“阶段 0”和“本地工程基线已就绪”。
- [ ] 右上角及页脚均显示 Power BI“未连接”。
- [ ] 页脚版本显示 `0.1.0`。
- [ ] 确认阶段划分、功能范围和非目标与技术开发文档一致。

验证结束后关闭窗口即可。

## 5. 阶段门禁

阶段 0 的工程交付和自动验证已经完成。只有项目负责人完成上述人工检查并明确回复“阶段 0
验收通过”后，才创建阶段验收标签并进入阶段 1；在此之前不得开发 Power BI 连接功能。
